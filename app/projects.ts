  ...
  en: [
    // KIA EV6 Unplugged
    {
      ...
      details: {
        ...
        descriptions: [
          "The Kia Unplugged EV6 project has been designed as a responsive website to introduce\noffline facilities where customers can test drive and experience the vehicle firsthand at\neach location. The design and planning were carried out to accurately inform customers\nnot only about the details of newly released vehicles but also to convey information from\nan experiential perspective, including test drive reservations and courses.",
          "The EV6's electric category seamlessly integrates into eco, style, and trend elements,\ncreating images that naturally blend and consider the customer's perspective to depict\nthe satisfaction they can envision when making a purchase.",
          "The design emphasizes the proper communication of the planning direction to customers\nin the mobile environment, ensuring that the identity of the product is well conveyed\nthrough the positioning and arrangement of assets. Various courses, events, and ongoing\nactivities are integrated to showcase a dynamic and engaging presentation, ensuring the\nessence of the product is effectively captured in the mobile environment compared to the\nPC setting.",
        ],
    ...
    // Dr.full
    {
      ...
      details: {
        ...
        descriptions: [
          "Plant Doctor goes beyond individual plant care, unlike existing platforms. It is a plant\ncommunity platform where people share their plants and explore information under the\nsame local weather conditions. We understood the business structure of existing plant\nplatforms, developed a business model suitable for the current market, and proceeded\nwith the beta service design, planning, and development accordingly.",
          "Plant Doctor goes beyond exchanging information on plant care to suggest products for\nbetter growth, taking into account sales items and local weather conditions. We\nconsidered extending the design and planning to the O2O realm, where users can\nencounter even better information.",
          "The key focus of this development was to provide accurate weather information for users\nresiding in different locations. Weather was identified as a crucial development element\nto optimize convenience and increase revisit rates by delivering a consistent service\nwithout delays or errors in weather updates.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // UFO Coffee
    {
      ...
      details: {
        ...
        descriptions: [
          "UFO Coffee is a B2B brand engaged in coffee bean roasting, but there was a need for\nweb development to expand into the B2C sector for selling its own coffee beans. This\nwebsite not only focuses on selling coffee beans but also incorporates various programs\nand content, providing a comprehensive web service.",
          "As mentioned, UFO Coffee not only sells coffee beans but also offers various entertaining\nelements on its website, including comics, programs, friendships, cinema, and more. The\ngoal was to create a layout where each element is displayed, and information is presented\nsmoothly for an engaging user experience.",
          "For a site with abundant content, it is crucial to understand what captures the customer's\ninterest which leads to purchases. With UFO Coffee, data was built to track customer\nroutes, including preferred content and purchased products across different age and\ngender demographics. Also, key management functions were developed for overall\noperations, such as reservations and necessary inquiries.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // +X+
    {
      ...
      details: {
        ...
        descriptions: [
          "descripti+X+ is a social communication application where users can share information about their\nlocal area by simply entering messages when they have questions or desire to know the\nlatest news. The unique element of this website is that all messages are text-based rather\nthan image, and the all messages are deleted after 24 hours.on1",
          "Since this service relies solely on messaging, we prioritized on accessibility and\nreadability. All designs are based on message boxes, allowing customers to choose from\nvarious colors for better visibility and readability.",
          "Although the service principle is to delete all messages after 24 hours, we designed the\nsystem to ensure that even if malicious messages or data exposing personal information\nwere to be deleted, it would be done thoroughly without any leakage. Development\nefforts were made to improve accessibility, ensuring that all customers can access\nand engage with the service without any difficulty.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // TetherMax
    {
      ...
      details: {
        ...
        descriptions: [
          "TetherMax is a platform that rewards users in the form of commissions for the frequent\ncryptocurrency transactions they engage in. It is designed to provide users with useful\ninformation and experience the benefits of rewards while conducting transactions.",
          "The advantage of transaction fees is that they offer more benefits when multiple users\nparticipate compared to one participant. The wow factor in this design focuses on\nconvenience by displaying information in a way that builds trust among users and\nencourages active participation, ensuring that more benefits can be gained through\ncollaboration.",
          "The system is designed to allow administrators to accurately analyze customer actions\nfrom the moment they choose a cryptocurrency exchange, proceed with authentication\nand payment, and receive rewards. This involves simultaneous development of both\nfront-end and back-end components, with consideration for maintenance-oriented\nmanagement functions, ensuring seamless business benefits continuation.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // Fuleaf
    {
      ...
      details: {
        ...
        descriptions: [
          "Fuleaf is a comprehensive plant platform starting with a fast and accurate plant search\nplatform that provides information for anyone curious about plant care. It expands into a\nB2B, B2C integrated plant platform where various plant-related products can be\npurchased.",
          "Beyond searching for a plant encyclopedia, Fuleaf goes further by collaborating\nwith affiliated writers to share content in a magazine format. The design and planning were\ncentered around allowing users to subscribe and continuously enjoy their plant life, and\ndevelopment was carried out based on this concept.",
          "To create a community and market within the platform, catering to plant enthusiasts, we\ncomprehensively reviewed various IA scenarios in different situations on the information-\nproviding platform. This approach ensures that when development continues in the\nfuture, diverse sub-objects can be seamlessly integrated to make the product even more\nrobust.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // Richgo
    {
      ...
      details: {
        ...
        descriptions: [
          "Richgo is a comprehensive real estate platform that provides regional real estate\ninformation based information on actual residents, actual transactions, and commercial\narea analysis. It assists both customers aiming to invest in real estate and those targeting\nresidential properties, enabling them to explore real estate tailored to their individual\nsituations.",
          "While many real estate platforms primarily focus on investment, Richgo places a stronger\nemphasis on the resident's perspective. It is designed to provide a comprehensive view\nof the surrounding environment, including nearby schools, amenities, medical facilities,\nand other practical factors that residents consider when living in a particular area.",
          "Presenting data visually for readers to comprehend can be difficult. In this project, special\nattention was given to design elements and focal points on each page, utilizing \ninfographics to make data more accessible and easily understandable for readers.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // Kick-off
    {
      ...
      details: {
        ...
        descriptions: [
          "Kick-off is an outsourcing O2O platform that facilitates connections between experts\nbidding for projects and partners looking to entrust their work. It is designed to address\nthe issues of excessive and false information present in traditional outsourcing platforms\nby providing access to partner information crafted with professionalism at reasonable\nprices.",
          "Kick-off is a two-way O2O platform, requiring constant interaction between partners\nand experts. While many pages and processes are inherent to such services, this platform\nwas designed with the majority of functions automated through CMS (Content\nManagement System). This approach allowed for a quick product launch to the market,\noptimizing the development timeline.",
          "As an O2O platform encompassing various experts, Kick-off caters to customers of\ndiverse professions and preferences. To make the Kick-off service memorable for users\nand encourage return visits, a unified identity was established. Simultaneously, planning\nfor a unique IP business was conducted, laying the foundation for a broad and impactful\nservice.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // Chart-in
    {
      ...
      details: {
        ...
        descriptions: [
          "Chart-in is a music community platform service for everyone who loves music and wants\nto discover new playlists. It features a community where individuals can promote\nthemselves, listen to and evaluate trending music, and receive feedback from other\nusers.",
          "UI features core colors that reflects a dark background resembling the environment\nwhere music creators concentrate on their work. Through the overall atmosphere\nand visual balance, users are encouraged to engage more professionally on Chart-in,\nfostering a sense of expertise",
          "Chart-in is a platform where users can upload their music, receive evaluations, and\npotentially lead to actual debut stages. It goes beyond just sharing one's work. it is a\ncomprehensive platform where music is evaluated and made public. The development\nenvironment was built to facilitate smooth interaction throughout this process.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // MarkHoly
    {
      ...
      details: {
        titles: [
          ...
          "Ensuring various posture of the characte\nare captured in different resolutions",
          "Energetic and dynamic\nlayout composition",
        ],
        descriptions: [
          "MarkHoly is a brand created by Mark Holy who has a high affection for Korean culture.\nThe brand name also sounds similar to Makgeolli which greatly represents brand’s\nidentity. Unlike traditional Makgeolli, the brand aims to showcase a trendy branding of\nMakgeolli on the web, effectively communicating with customers.",
          "The essence of MarkHoly lies in the character's appearance and actions. Occasionally,\nthere may be cases where the images are cropped or appears differently when exposed\nto different devices. In this development and design, efforts were made to ensure the\nentire landing page are presented uniformly across various device environments.",
          "descriptMarkHoly aims beyond selling Makgeolli and envisions business expansion into the IP\ncategory. The look and feel composition, showcasing various postures and styles of the\ncharacter, and presenting the products were crucial. In this web design, we emphasized\nthe fine-tuning of the overall composition and section structure for each scroll to\neffectively capture the essence of the brand in the layout.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
  ...
  ko: [
    // KIA
    {
      ...
      details: {
        ...
        descriptions: [
          "기아 언플러그드 EV6 프로젝트는 각 지점별 시승 및 차량 경험이 가능한 오프라인 시설을 소개하기 위한\n반응형 웹 사이트로 제작이 되었습니다. 고객들이 새롭게 출시되는 차량에 대한 정보를 제대로 인지하는\n것과 더불어 시승 예약, 코스 등 경험 관점의 정보를 제대로 전달하기 위해 디자인 / 기획을 진행하였습니다.",
          "EV6의 전기 카테고리를 활용한 에코, 스타일, 트랜드에 자연스럽게 녹아들며 실질적으로 구매 시 고객이\n얻는 만족감을 상상할 수 있는 이미지 등을 고객의 시선 방향에 고려하여 제작 표현되었습니다.",
          "PC 환경보다 모바일 환경에서 기획 방향이 제대로 고객에게 전달이 될 수 있도록 에셋들간의 위치 배열\n등 소개하고자 하는 제품의 정체성이 잘 담겨지도록 설계하였으며 다양한 코스, 이벤트 등이 지속적으로\n운영되어 보여질 수 있도록 제작하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 풀박사
    {
      ...
      details: {
        ...
        descriptions: [
          "풀박사는 기존에 플랫폼들과 달리 혼자 키우는 식물을 넘어서 사람들끼리 같은 지역 날씨 환경 아래 자신\n들의 식물을 공유하고 정보를 탐색하는 식물 커뮤니티 플랫폼입니다. 기존 식물 플랫폼의 비즈니스 구조\n를 이해하고 현 시장에 알맞는 비즈니스 구조를 함께 설계를 하였고 이에 따른 베타 서비스 디자인, 기획,\n개발을 진행하였습니다.",
          "풀박사는 식물을 키우는 정보를 교류하는 것을 넘어 더 잘 키우기 위해서 접하는 판매 제품 및 지역별 날\n씨를 제안하고 더 좋은 정보를 만날 수 있는 O2O 영역까지의 확장을 고려하며 디자인 및 기획 설계를 진\n행하였습니다.",
          "이번 개발의 핵심은 모두가 다른 지역에 거주하면서 각자 위치의 날씨 정보를 정확하게 제공 받는 것이었\n습니다. 개발 요소 중 날씨가 딜레이 & 오차 없이 일정한 서비스를 제공하여 편의성, 재방문률을 높일 수\n있는 개발 요소의 최적화를 목표로 진행하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // ufo
    {
      ...
      details: {
        ...
        descriptions: [
          "유에프오커피는 원두 로스팅 컴퍼니로 B2B를 진행하는 브랜드이지만\n자체적 원두 생산 판매를 할 수 있는 B2C 영역의 확장으로 이에 맞는 웹 구축이 필요했습니다. 이번 웹사\n이트에서는 단순히 원두를 판매하는 것 뿐만이 아니라 다양한 프로그램, 콘텐츠까지 확인할 수 있는 웹 서\n비스를 구축하였습니다.",
          "앞서 말한 것과 같이 유에프오커피는 원두를 판매하는 것과 동시에 다양한 콘텐츠를 확인할 수 있는 코믹\n스, 프로그램, 프랜드쉽, 시네마 등 다양한 재미 요소를 품고 있는 웹 사이트입니다. 각 요소들이 보여지는\n레이아웃, 정보들이 원활하게 보일 수 있는 것을 목표로 제작이 되었습니다.",
          "콘텐츠가 많은 사이트일 수록 고객이 어떤 것에 흥미를 갖고 구매까지 이어지는지 확인하는 것이 필요합\n니다. 이번 유에프오커피는 각 연령, 성별 고객이 어떤 데이터를 가장 좋게 보고 있고 어떤 제품을 구매를\n하였는지 고객의 루트를 확인할 수 있는 데이터 구축 뿐만이 아니라 전체 예약, 문의 등 기본적인 시스템\n운영에 필요한 관리 기능을 개발하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // +X+
    {
      ...
      details: {
        ...
        descriptions: [
          "+X+는 사람들이 궁금한게 있을 때 그 지역에 대한 소식을 알고싶을 때 자신이 있는 지역에서 메시지를 가\n볍게 입력하여 정보를 공유하는 소셜 커뮤니케이션 애플리케이션입니다. 모든 메세지는 이미지가 아닌 텍\n스트 위주로 올라가도록 되어있고하루가 지나면 모든 메세지가 삭제되는 위주로 제작이 되었습니다.",
          "메세지로만 소통을 해야하는 서비스다보니 그 무엇보다 접근성, 시인성이 좋아야하는 이유가 있었습니다.\n모든 디자인은 메시지 박스를 기반으로 다양한 색상을 고객들이 선택하고 볼 수 있도록 하였습니다.",
          "모든 메시지가 24시간 후 삭제가 되는 것을 서비스 원칙으로 하고 있지만\n악성 메시지를 비롯하여 여러 개인정보에 노출이 될 수 있는 데이터를 유출이 되지않고 삭제가 되더라도\n완벽히 될 수 있도록 설계하였고 모든 고객들이 접근을 하고 활동하는데 있어서 어려움이 없도록 접근성\n을 개선한 개발을 진행하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // tethermax
    {
      ...
      details: {
        ...
        descriptions: [
          "테더맥스는 많은 사람들이 수시로 거래되는 가상화폐 거래 시 발생하는 수수료를 리워드 형식으로 제공하\n는 플랫폼입니다. 많은 고객들이 거래를 하는데 있어서 더 좋은 정보를 얻고 리워드 편익을 온전히 느낄\n수 있도록 제작되었습니다.",
          "거래 수수료는 한명이 아닌 다수가 참여를 했을 때 더 많은 혜택을 줄 수 있다는 장점이 존재를 합니다. 이\n번 디자인의 와우 포인트는 여러 유저들이 신뢰할 수 있고 더 많은 혜택을 여러 사람들과 적극적으로 참여\n할 수 있도록 정보를 보여주는 편의성에 집중하여 제작되었습니다.",
          "어떤 유저가 거래소를 선택을 하였고, 결제를 진행 하는 것에 대해 인증을 하고 리워드가 지급이 되었는지\n관리자 시점에서 정확하게 고객의 행동을 분석하고 비즈니스 편익을 이어갈 수 있도록 프론트와 백앤드\n개발과 동시에 유지보수 개념의 관리 기능까지 고려하여 제작하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    ...
    // TODO: 썸네일이미지
    {
      ...
      details: {
        ...
        descriptions: [
          "플립은 식물을 키우는 누구나 궁금해하는 정보를 빠르고 정확하게 전달받을 수 있는 식물 검색 플랫폼을\n시작으로 다양한 식물 관련 제품을 구매할 수 있는 B2B, B2C 종합 식물 플랫폼입니다.",
          "플립은 식물 도감을 검색하는 것을 넘어 제휴 작가와 함께 콘텐츠를 매거진 형식으로 공유하고 사용자가\n구독자가 되어 식물 라이프를 지속적으로 향유할 수 있는 것을 중심으로 설계 된 디자인과 기획을 바탕으\n로 개발을 진행하였습니다.",
          "정보를 제공하는 플랫폼에서 식물을 좋아하는 매니아층이 모여 하나의 커뮤니티와 마켓을 만들 수 있도록\n여러 상황의 IA를 종합적으로 검토하여 훗날에도 개발을 진행 하였을 때 다양한 서브 오브젝트들이 붙어\n더욱 강력한 프로덕트가 될 수 있도록 개발을 진행하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 리치고
    {
      ...
      details: {
        ...
        descriptions: [
          "리치고는 데이터 기반으로 만들어지는 실거주자, 실거래, 상권분석 등의 정보를 지역별 부동산 정보를 제\n공하는 종합 부동산 플랫폼으로 부동산을 투자하는 고객과 실거주를 목표로 하는 고객 모두가 자신의 상\n황에 맞게 부동산을 탐색할 수 있도록 도와주는 플랫폼입니다.",
          "모든 부동산 플랫폼이 대부분 투자에 포커스를 두고 있지만 이번 리치고에서는 거주자 관점을 더욱 집중\n하여 주변 학군을 비롯해 편의시설, 의료시설 등 실질적으로 거주 시 얻을 수 있는 주변 시설의 환경까지\n한눈에 확인할 수 있도록 제작되었습니다.",
          "데이터라는 것은 기본적으로 보여지도록 만들기도 어려울 뿐더러 읽는 사람에게도 어려움을 동반할 수 있\n는 카테고리입니다. 이번 제작에는 데이터가 더욱 쉽고 인포그래픽을 활용하여 고객에게 잘 전달될 수 있\n도록 디자인 요소와 페이지 마다의 집중 요소를 면밀히 체크하여 제작하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 킥오프
    {
      ...
      details: {
        ...
        descriptions: [
          "킥오프는 프로젝트를 수주하는 전문가와 일을 맡겨야하는 파트너간의 연결을 도와주는 아웃소싱 O2O 플\n랫폼입니다. 기존의 아웃소싱 플랫폼이 가지고 있었던 과도한 정보와 허위 정보를 잡고 전문성으로 만들\n어진 파트너 정보를 합리적인 가격으로 이용이 될 수 있도록 제작되었습니다.",
          "킥오프는 양방향 O2O 플랫폼으로 파트너와 전문가가 상시 교류를 해야하는 서비스입니다. 그러므로 다\n양한 페이지가 존재하고 과정이 있는 것이 다반사이지만 이번 플랫폼에서는 최대한 대부분의 기능은\nCMS를 통해 자동화로 진행이 될 수 있도록 제작이 되었고 이 과정을 통해 시장에 더욱 빠르게 제품을 선\n보일 수 있는 최적의 작업 기간으로 진행하였습니다.",
          "O2O 플랫폼이면서 다양한 전문가를 담고 있는 킥오프는 그만큼 다양한 직군과 성향의 고객들을 맞이하\n는 서비스 중 하나입니다. 이러한 고객들이 더욱 킥오프라는 서비스를 기억하고 다시금 방문할 수 있도록\n통일화된 아이덴티티를 구축함과 동시에 고유 IP 사업 기획까지 진행하여 폭 넓은 서비스가 될 수 있는 발\n판을 마련하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 차트인
    {
      ...
      details: {
        ...
        descriptions: [
          "차트인은 음악을 좋아하는 사람, 음악을 찾고 싶은 사람 모두가 즐길 수 있는 음악 커뮤니티 플랫폼 서비\n스입니다. 다수의 사람들이 자신을 PR하고 더 나아가 현재 트랜드로 자리잡고 있는 음악 등을 함께 듣고\n평가하고 평가를 받을 수 있는 서비스의 특징을 담고 있습니다.",
          "음악을 만드는 사람들이 방 안에서 자신의 음악에 집중하며 마주하는 컬러처럼 어두운 다크 배경에 핵심\n적인 컬러가 UI에 작용할 수 있도록 제작되었습니다. 전체적인 분위기나 비주얼 벨런스를 통해 고객이 더\n욱 차트인에서 활동하며 전문성을 키울 수 있도록 하였습니다.",
          "차트인은 음악을 올리고 평가를 받아 실제로 데뷔 무대까지 이어질 수 있는 플랫폼으로 단순히 자신의 작\n업물을 올리는 것에 그치는 것이 아닌 실제로 평가를 받아 사람들에게 공개가 되는 종합 플랫폼의 모습을\n띄고 있습니다. 이러한 과정이 원활하게 상호작용 될 수 있도록 개발 환경을 구축, 제작 되었습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 마크홀리
    {
      ...
      details: {
        ...
        descriptions: [
          "마크홀리는 막걸리를 부르는 말인 것 같으면서도 한국을 좋아하는 마크홀리씨가 막걸리를 만드는 브랜드\n아이덴티티를 갖고있는 브랜드입니다. 기존 전통 막걸리와 달리 힙한 스타일의 막걸리 브랜드가 웹에서\n잘 보여지고 고객들에게 전달 될 수 있는 것을 목표로 제작하였습니다.",
          "마크홀리의 핵심은 캐릭터의 모습, 행동입니다. 간혹 다양한 디바이스의 환경에\n노출이 될 때 이미지의 규격이 달라지면서 이미지가 잘리는 경우가 발생하는데\n이번 개발과 디자인에는 전체 랜딩을 구성하는데 있어서 콘텐츠의 요소들이 다양한 디바이스 환경에서 달\n리 보이지 않도록 제작하였습니다.",
          "마크홀리는 막걸리를 판매하는 것을 넘어 IP사업까지 바라보고 있는 비즈니스 카테고리로 캐릭터의 다양\n한 포즈와 스타일을 보여주는 것과 제품이 보여지는 것에 룩 앤 필 구성이 가장 중요했습니다. 이번 웹에\n서는 전체 구성의 강약조절과 브랜드에 맞는 스크롤 마다의 섹션 구성을 레이아웃에 잘 담길 수 있도록 하\n는 것을 중요하게 생각하여 제작하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
    // 구해줘 노무사
    {
      ...
      details: {
        ...
        descriptions: [
          "구해줘 노무사는 노무사와 고객사 모두가 노무에 대한 업무를 온라인에서 진행할 수 있는 노무 종합 O2O\n플랫폼입니다. 다양한 법적인 문제부터 빠르게 체크하며 진행되어야 하는 노무의 특성이 온라인에서 제약\n없이 서비스 진행이 될 수 있도록 제작되었습니다.",
          "노무사는 자신들의 포트폴리오와 고객 상담 등을 자유롭게 받으며 업무에 플러스가 될 수 있도록 제작을\n하였고 더불어 고객들은 자신의 상황을 빠르게 여러 노무사들에게 상담 받을 수 있도록 전체 상황을 고려\n한 기획, 설계, 디자인에 초점을 맞춰 진행하였습니다.",
          "구해줘 노무사는 상담을 진행하는 노무사, 파트너 둘 다 자신이 어디까지 진행을 하고 있고 어떤 상담 등\n을 진행하고 있는지 서비스 운영 관리와 별도로 개별 모니터링 시스템이 필요한 플랫폼입니다. O2O를 경\n험하는 모든 고객들이 자신의 서비스 상황을 정확하게 인지하고 빠르게 다음 서비스로 이어갈 수 있도록\n최적화된 개발 환경을 구축하였습니다.",
        ],
        images: ["이미지 경로_01", "이미지 경로_02"],
      },
    },
